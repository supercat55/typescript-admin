...
class BatchCreateResidentPage extends PureComponent<IProps, IState> {
  state = {
    currentStep: 0,
    currentCommunityId: '',
  ...
  handleDownloadTemplate = () => {
    window.open('https://wanjia.sh1a.qingstor.com/model/住户导入模板.xls');
  }
  ...
  handleSubmit = async() => {
    ...
    let result = await dispatch({
      type: 'resident/createBatchResident',
      payload: params
    })
...
export default Form.create()(BatchCreateResidentPage);
